...
public final class EndpointConstant {
	...
	public static final List<String> HEADER_EXPORT_EXCEL_MOVIE = Arrays.asList("Name", "Year", "Director");
	public static final String DATA_EXPORT_EXCEL_MOVIE = "name, year, director";
